...
Use no more than year precision for project history and class metadata. Keep exact dates only where technically required, such as dependency-version checks.
